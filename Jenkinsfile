pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamioh-howar181/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('howar181-225')   // <---- Change this to match your kubernetes cluster credentials
    }
